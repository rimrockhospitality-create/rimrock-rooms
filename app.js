...
async function loadDailyOperationsReport_(){
 ...
 const assignments=today.assignments||[],clean=today.cleaningSessions||[],ins=today.inspections||[],issues=today.inspectionIssues||[],maintToday=today.maintenance||today.maintenanceIssues||[],maintRaw=maintenanceReport.ok&&Array.isArray(maintenanceReport.maintenance)?maintenanceReport.maintenance:maintToday,maint=maintRaw,syncs=today.choiceSyncs||today.syncs||[],roomPhotos=today.roomPhotos||today.photos||[],propertyWalkPhotos=today.propertyWalkPhotos||[];
