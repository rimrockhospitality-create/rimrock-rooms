...
async function loadDailyOperationsReport_(){
 ...
 const assignments=today.assignments||[],clean=today.cleaningSessions||[],ins=today.inspections||[],issues=today.inspectionIssues||[],maint=today.maintenance||today.maintenanceIssues||[],syncs=today.choiceSyncs||today.syncs||[],roomPhotos=today.roomPhotos||today.photos||[];
