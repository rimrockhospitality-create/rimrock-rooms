...
function renderSideWorkBoardFromState_(r){
 ...
 const tasks=(r.sideWork||[]).filter(x=>x.status!=='COMPLETE'&&(isMonitor||isWorker&&x.assignedTo===worker));if(isWorker)tasks.forEach(t=>{if(t.sessionId)activeSideWorkSessions[t.taskId]=t.sessionId});
