...
async function loadDailyOperationsReport_(){
 ...
 document.getElementById('dorMaintenance').innerHTML=[dorMetric_('Issues Logged',maint.length),dorMetric_('Resolved',maint.length-maintOpen.length),dorMetric_('Still Open',maintOpen.length)].join('');
